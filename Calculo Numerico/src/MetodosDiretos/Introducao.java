...
public class Introducao {
	...
	public static void main(String []args) {
		...
		double []diagonalprincipal = new double[numcolumn];
		double [][]matriz = new double[numline][numcolumn];
		...
		System.out.print("\nDIGITE O VALOR DE b:");
		double []valorb = new double[numcolumn];
	   ...
	   System.out.println("\nMATRIZ DE ORDEM " + numline +"x" + numcolumn);
	   if(numline == numcolumn)
		   verdadeiro = true;
	   ...
	   System.out.println("\nMATRIZ INDENTIDADE:");
	   double [][]matrizindentidade = new double[numline][numcolumn];
		for(int x = 0; x <numline; x++) {
			for(int y = 0;y<numcolumn;y++) {
				if(x == y)
